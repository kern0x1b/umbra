...
#ifdef _WIN32
const Xbyak::Reg64 BlockOfCode::ABI_RETURN = HostLocToReg64(Umbra::Backend::X64::ABI_RETURN);
const Xbyak::Reg64 BlockOfCode::ABI_PARAM1 = HostLocToReg64(Umbra::Backend::X64::ABI_PARAM1);
const Xbyak::Reg64 BlockOfCode::ABI_PARAM2 = HostLocToReg64(Umbra::Backend::X64::ABI_PARAM2);
const Xbyak::Reg64 BlockOfCode::ABI_PARAM3 = HostLocToReg64(Umbra::Backend::X64::ABI_PARAM3);
const Xbyak::Reg64 BlockOfCode::ABI_PARAM4 = HostLocToReg64(Umbra::Backend::X64::ABI_PARAM4);
...
#else
const Xbyak::Reg64 BlockOfCode::ABI_RETURN = HostLocToReg64(Umbra::Backend::X64::ABI_RETURN);
const Xbyak::Reg64 BlockOfCode::ABI_RETURN2 = HostLocToReg64(Umbra::Backend::X64::ABI_RETURN2);
const Xbyak::Reg64 BlockOfCode::ABI_PARAM1 = HostLocToReg64(Umbra::Backend::X64::ABI_PARAM1);
const Xbyak::Reg64 BlockOfCode::ABI_PARAM2 = HostLocToReg64(Umbra::Backend::X64::ABI_PARAM2);
const Xbyak::Reg64 BlockOfCode::ABI_PARAM3 = HostLocToReg64(Umbra::Backend::X64::ABI_PARAM3);
const Xbyak::Reg64 BlockOfCode::ABI_PARAM4 = HostLocToReg64(Umbra::Backend::X64::ABI_PARAM4);
const Xbyak::Reg64 BlockOfCode::ABI_PARAM5 = HostLocToReg64(Umbra::Backend::X64::ABI_PARAM5);
const Xbyak::Reg64 BlockOfCode::ABI_PARAM6 = HostLocToReg64(Umbra::Backend::X64::ABI_PARAM6);
...
#else
    static constexpr size_t UMBRA_PAGE_SIZE = 4096;
...
#    endif
        ...
        return static_cast<uint8_t*>(p) + UMBRA_PAGE_SIZE;
    }

    void free(uint8_t* p) override {
        size_t size;
        std::memcpy(&size, p - UMBRA_PAGE_SIZE, sizeof(size_t));
        munmap(p - UMBRA_PAGE_SIZE, size);
    }

#    ifdef UMBRA_ENABLE_NO_EXECUTE_SUPPORT
    bool useProtect() const override { return false; }
#    endif
#endif
};
...
#ifdef UMBRA_ENABLE_CPU_FEATURE_DETECTION
...
void BlockOfCode::GenRunCode(std::function<void(BlockOfCode&)> rcp) {
    ...
    PerfMapRegister(run_code, getCurr(), "umbra_dispatcher");
}
