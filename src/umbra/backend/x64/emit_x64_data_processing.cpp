...
void EmitX64::EmitExtractRegister32(Umbra::Backend::X64::EmitContext& ctx, IR::Inst* inst) {
    EmitExtractRegister(code, ctx, inst, 32);
}

void EmitX64::EmitExtractRegister64(Umbra::Backend::X64::EmitContext& ctx, IR::Inst* inst) {
...
void EmitX64::EmitReplicateBit32(Umbra::Backend::X64::EmitContext& ctx, IR::Inst* inst) {
    EmitReplicateBit(code, ctx, inst, 32);
}

void EmitX64::EmitReplicateBit64(Umbra::Backend::X64::EmitContext& ctx, IR::Inst* inst) {
