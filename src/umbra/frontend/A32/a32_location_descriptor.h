...
namespace std {
template<>
struct less<Umbra::A32::LocationDescriptor> {
    bool operator()(const Umbra::A32::LocationDescriptor& x, const Umbra::A32::LocationDescriptor& y) const noexcept {
        return x.UniqueHash() < y.UniqueHash();
    }
};
template<>
struct hash<Umbra::A32::LocationDescriptor> {
    size_t operator()(const Umbra::A32::LocationDescriptor& x) const noexcept {
...
template<>
struct fmt::formatter<Umbra::A32::LocationDescriptor> : fmt::formatter<std::string> {
    template<typename FormatContext>
    auto format(Umbra::A32::LocationDescriptor descriptor, FormatContext& ctx) const {
        return formatter<std::string>::format(Umbra::A32::ToString(descriptor), ctx);
    }
};
