...
#if !defined(UMBRA_IGNORE_ASSERTS) && !defined(__ANDROID__)
...
#define UMBRA_DECODER_GET_MATCHER(MatcherT, fn, name, bitstring) Decoder::detail::detail<MatcherT<V>>::template GetMatcher<bitstring>(&V::fn, name)
